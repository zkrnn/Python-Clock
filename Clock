...
time_label = Label(clock_tab, font = 'times 40 bold', foreground = 'black')
time_label.pack(anchor='center')
date_label = Label(clock_tab, font = 'times 40 bold', foreground = 'black')
date_label.pack(anchor='s')
get_alarm_time_entry = Entry(alarm_tab, font = 'times 15 bold')
get_alarm_time_entry.pack(anchor='center')
alarm_instructions_label = Label(alarm_tab, font = 'ctimes 10 bold', text = "Enter Alarm Time.")
...
alarm_status_label = Label(alarm_tab, font = 'times 15 bold')
...
timer_instructions_label = Label(timer_tab, font = 'times 10 bold', text = "Enter Timer Time. [01:30:30]")
